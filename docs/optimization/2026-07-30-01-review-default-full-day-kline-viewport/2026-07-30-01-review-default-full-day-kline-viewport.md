...
| Default behavior | No manual `- Zoom`, wheel zoom, drag, or `Overview` click is required to see the entire displayed day after a Review or Static Review payload loads. |
...
| --- | --- | --- | ---: | ---: |
| [`current-default-partial-day-kline.png`](./screenshots/current-default-partial-day-kline.png) | User-provided current-state evidence: first paint exposes only the latest portion of the day | `d07750ee597f3e44981f6cc51e0c28ebcc93bb5a8f8c54d392e8503be69ffba4` | 625,254 bytes | 2769×1619 |
...
- Current friction:
  ...
  - The `Overview` accessibility/title contract says full day while the implementation returns to the partial default window.
- Desired outcome:
