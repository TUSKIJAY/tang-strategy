...
| --- | --- | --- | --- | --- | --- |
| OPT-001 | Align Data page Market days rail with Review progressive date navigation | Data workspace / `DashboardPage` date rail | recorded | none | User acceptance 2026-07-21 after Review progressive ship |
