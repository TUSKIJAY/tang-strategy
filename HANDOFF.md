...
- Latest design review: `docs/exec-plans/reviews/2026-07-21-tang-strategy-trade-tools-group-span-viewport-data-rail-plan/review-001.md` — `revise/high`, four findings.
...
- Required foldback: canonical display-only list/export semantics; executable group-span fit + real band + event-focus decision; one mandatory first-frame TF carrier; Data-specific density scope with Review sidebar regression evidence.
- Next gate: plan-author foldback to a new stable revision, then independent review of that exact revision.
...
4. Next durable step is plan-author foldback of `review-001` into a new stable Proposed revision — not activation or implementation.
